  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-tr from-slate-900 to-gray-950">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full font-bold rounded-lg bg-gradient-to-r from-green-500 to-emerald-400 text-white p-2.5 text-xl shadow-lg hover:from-green-600 hover:to-green-500 hover:shadow-emerald-500/50 transition-all duration-200"
        >
          Login
        </button>
